 ...
 *  @OA\Get(
 *      tags={"artshow"},
 *      path="/artshow/art/find",
 *      summary="Search for a piece of art based on the query",
 *      @OA\Parameter(
 ...
 *              @OA\Items(
 *                  type="string",
 *                  enum={"all","artist_name","piece_name"}
 *              )
 *          ),
 *          style="simple",
 *          explode=false
 ...
 *          @OA\JsonContent(
 *           ref="#/components/schemas/artshow_found_art_list"
 *          )
 *      ),
 *      @OA\Response(
 *          response=401,
 ...
 *
 *  @OA\Schema(
 *      schema="artshow_found_art_list",
 *      @OA\Property(
 *          property="type",
 *          type="string",
 *          enum={"artshow_found_art_list"}
 *      ),
 *      @OA\Property(
 *          property="data",
 *          type="array",
 *          description="List of hung art found",
 *          @OA\Items(
