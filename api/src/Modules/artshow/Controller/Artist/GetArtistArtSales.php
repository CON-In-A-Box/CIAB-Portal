...
class GetArtistArtSales extends \App\Modules\artshow\Controller\Sale\BaseSale
{
    ...
    public function buildResource(Request $request, Response $response, $params): array
    {
        ...
        $data = Select::new($this->container->db)
            ...
            ->andWhere("PieceID IN (Select PieceID FROM Artshow_DisplayArt where ArtistID = ".$params['artist'].")")
            ->fetchAll();
