...
class PutPrintSale extends PutSale
{


    public function __construct(Container $container)
    {
        parent::__construct($container, 'Artshow_Print_Sale', '\App\Modules\artshow\Controller\Sale\GetPrintSale');
